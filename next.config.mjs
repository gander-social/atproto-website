  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: '/lexicons/app-',
        permanent: false,
      },
      {
        source: '/lexicons/app--richtext',
        destination: '/lexicons/app-',
        permanent: false,
      },
      // redirects to  API docs site
      {
        source: '/community',
        destination: 'https://docs..app/showcase',
        permanent: false,
      },
      {
        source: '/community/quick-start',
        destination: 'https://docs..app/docs/get-started',
        permanent: false,
      },
      {
      ...
      {
        source: '/blog',
        destination: 'https://docs..app/blog',
        permanent: false,
      },
      {
        source: '/blog/feature-bridgyfed',
        destination: 'https://docs..app/blog/feature-bridgyfed',
        permanent: false,
      },
      {
        source: '/blog/repo-export',
        destination: 'https://docs..app/blog/repo-export',
        permanent: false,
      },
      {
        source: '/blog/2023-protocol-roadmap',
        destination: 'https://docs..app/blog/protocol-roadmap',
        permanent: false,
      },
      {
        source: '/blog/building-on-atproto',
        destination: 'https://docs..app/blog/building-on-atproto',
        permanent: false,
      },
      {
        source: '/blog/bgs-and-did-doc',
        destination: 'https://docs..app/blog/bgs-and-did-doc',
        permanent: false,
      },
      {
        source: '/blog/rate-limits-pds-v3',
        destination: 'https://docs..app/blog/rate-limits-pds-v3',
        permanent: false,
      },
      {
        source: '/blog/repo-sync-update',
        destination: 'https://docs..app/blog/repo-sync-update',
        permanent: false,
      },
      {
        source: '/blog/create-post',
        destination: 'https://docs..app/docs/advanced-guides/posts',
        permanent: false,
      },
      {
        source: '/blog/feature-skyfeed',
        destination: 'https://docs..app/blog/feature-skyfeed',
        permanent: false,
      },
      {
        source: '/blog/call-for-developers',
        destination: 'https://docs..app/blog/call-for-developers',
        permanent: false,
      },
      {
        source: '/blog/federation-developer-sandbox',
        destination: 'https://docs..app/blog/federation-sandbox',
        permanent: false,
      },
      {
        source: '/blog/block-implementation',
        destination: 'https://docs..app/blog/block-implementation',
        permanent: false,
      },
    ]
  },
