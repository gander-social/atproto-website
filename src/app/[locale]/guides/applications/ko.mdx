...
사용자에 대해 좀 더 알아볼까요? [Bluesky](https://gndr.app)에서는 사용자가 "프로필" 레코드를 게시하며, 다음과 같은 구조를 가집니다:
...
이 레코드는 [atproto-browser.vercel.app](https://atproto-browser.vercel.app)에서 직접 확인할 수 있습니다. 예를 들어, [@gndr.app의 프로필](https://atproto-browser.vercel.app/at?u=at://did:plc:z72i7hdynmk6r22z27h6tvur/app.gndr.actor.profile/self)을 볼 수 있습니다.
...
router.get(
  ...
  handler(async (req, res) => {
    ...
    const { data: profileRecord } = await agent.com.atproto.repo.getRecord({
      ...
      collection: 'app.gndr.actor.profile', // Bluesky 프로필 레코드
      rkey: 'self',                         // 레코드 키
    })
