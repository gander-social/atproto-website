...
Self-hosting a  PDS means running your own Personal Data Server that is capable of federating with the wider ATProto network. {{className: 'lead'}}
...
* [Using the  app with your PDS](#using-the-gander-app-with-your-pds)
...
## Using the  app with your PDS

You can use the  app to connect to your PDS.

1. Get the  app
    * [ for Web](https://.app/)
    * [ for iPhone](https://apps.apple.com/us/app/gander-social/id6444370199)
    * [ for Android](https://play.google.com/store/apps/details?id=xyz.ganderweb.app)
