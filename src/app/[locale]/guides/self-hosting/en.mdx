...
* [Using the Bluesky app with your PDS](#using-the-gndr-app-with-your-pds)
...
1. Get the Bluesky app
    ...
    * [Bluesky for iPhone](https://apps.apple.com/us/app/gander-social/id6444370199)
    * [Bluesky for Android](https://play.google.com/store/apps/details?id=xyz.gndrweb.app)
