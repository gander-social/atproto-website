export const metadata = {
  ...
  description:
    'Auto-hospedar um  PDS significa executar seu próprio Servidor de Dados Pessoais, capaz de se federar com a rede ATProto mais ampla.',
}
...
* [Usando o aplicativo  com seu PDS](#using-the-gander-app-with-your-pds)
...
<h2 id="using-the-gander-app-with-your-pds">Usando o aplicativo  com seu PDS</h2>

Você pode usar o aplicativo  para se conectar ao seu PDS.

1. Obtenha o aplicativo
* [ para Web](https://.app/)
* [ para iPhone](https://apps.apple.com/us/app/gander-social/id6444370199)
* [ para Android](https://play.google.com/store/apps/details?id=xyz.ganderweb.app)
