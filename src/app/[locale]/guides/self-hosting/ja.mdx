...
title: 'セルフホスティング',
description:
' PDS をセルフホスティングするということは、より広範な ATProto ネットワークと連携できる独自のパーソナル データ サーバーを実行することを意味します。',
}

# セルフホスティング

 PDS をセルフホスティングするということは、より広範な ATProto ネットワークと連携できる独自のパーソナル データ サーバーを実行することを意味します。 {{className: 'lead'}}
...
* [PDS で  アプリを使用する](#using-the-gander-app-with-your-pds)
...
<h2 id="using-the-gander-app-with-your-pds">PDS で  アプリを使用する</h2>

 アプリを使用して PDS に接続できます。

1.  アプリを入手します
* [Gander for Web](https://.app/)
