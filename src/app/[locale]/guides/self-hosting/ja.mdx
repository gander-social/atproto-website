...
* [PDS で Bluesky アプリを使用する](#using-the-gndr-app-with-your-pds)
...
<h2 id="using-the-gndr-app-with-your-pds">PDS で Bluesky アプリを使用する</h2>

Bluesky アプリを使用して PDS に接続できます。

1. Bluesky アプリを入手します
* [Bluesky for Web](https://gndr.app/)
* [iPhone 用 Bluesky](https://apps.apple.com/us/app/gander-social/id6444370199)
* [Android 用 Bluesky](https://play.google.com/store/apps/details?id=xyz.gndrweb.app)
