...
* [PDS와 함께 Bluesky 앱 사용하기](#using-the-gndr-app-with-your-pds)
...
<h2 id="using-the-gndr-app-with-your-pds">PDS와 함께 Bluesky 앱 사용하기</h2>

Bluesky 앱을 사용하여 PDS에 연결할 수 있습니다.

1. Bluesky 앱 받기
    * [웹용 Bluesky](https://gndr.app/)
    * [iPhone용 Bluesky](https://apps.apple.com/us/app/gander-social/id6444370199)
    * [Android용 Bluesky](https://play.google.com/store/apps/details?id=xyz.gndrweb.app)
