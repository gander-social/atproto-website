...
# PDS 자체 호스팅
 ...
 PDS를 자체 호스팅한다는 것은 ATProto 네트워크와 연동할 수 있는 Personal Data Server(PDS)를 직접 운영하는 것을 의미합니다. {{className: 'lead'}}
...
* [PDS와 함께  앱 사용하기](#using-the-gander-app-with-your-pds)
...
<h2 id="using-the-gander-app-with-your-pds">PDS와 함께  앱 사용하기</h2>

 앱을 사용하여 PDS에 연결할 수 있습니다.
