...
export const metadata = {
  ...
  description:
    'AT Protocol é a tecnologia desenvolvida na  para redes sociais abertas. Neste artigo, vamos explorar o AT Proto da perspectiva da engenharia de backend distribuída.',
}
...
O AT Protocol é a tecnologia desenvolvida na [](https://.app) para redes sociais abertas. Neste artigo, exploraremos o AT Proto da perspectiva da engenharia de backend distribuída. {{className: 'lead'}}
