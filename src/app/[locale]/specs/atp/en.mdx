...
These specifications cover most details as implemented in 's reference implementation. A few important pieces have not been finalized, both in that reference implementation and in these specifications.
